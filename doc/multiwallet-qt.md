...
Only requiring some minor changes is astercoin.cpp.
...
Changes to astercoin.cpp
----------------------
astercoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
