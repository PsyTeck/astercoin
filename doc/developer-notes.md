...
Astercoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 5989.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 5898 for connections and services them.
...
However, in open source software such as Astercoin Core, where everyone uses
...
pay attention to for reviewers of Astercoin Core code.

General Astercoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Astercoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
