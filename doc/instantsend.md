...
This mechanism has been integrated into Bitcore-Node-Astercoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/PsyTeck/insight-api-astercoin#web-socket-api](https://github.com/PsyTeck/insight-api-astercoin#web-socket-api)
* API: [https://github.com/PsyTeck/insight-api-astercoin#instantsend-transactions](https://github.com/PsyTeck/insight-api-astercoin#instantsend-transactions)
...
By default, the Astercoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Astercoin Core daemon:
