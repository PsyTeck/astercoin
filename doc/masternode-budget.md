...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ ATE, _12_ times over the course of a year totaling _24000_ ATE.
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` ATE to ```y6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7```.
