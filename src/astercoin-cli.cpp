...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Astercoin Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  astercoin-cli [options] <command> [params]  " + _("Send command to Astercoin Core") + "\n" +
                  "  astercoin-cli [options] help                " + _("List commands") + "\n" +
                  "  astercoin-cli [options] help <command>      " + _("Get help for a command") + "\n";
