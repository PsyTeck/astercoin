    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Astercoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Astercoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  astercoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Astercoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ASTERCOIN, 0.1 ASTERCOIN, 1 ASTERCOIN and 10 ASTERCOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://PsyTeck.atlassian.net/wiki/display/DOC/PrivateSend\">https://PsyTeck.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Astercoin Core is shutting down...") + "<br /><br />" +
