    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Astercoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Astercoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and astercoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Astercoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Astercoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Astercoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Astercoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Astercoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a astercoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Astercoin Core help message to get a list with possible Astercoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Astercoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Astercoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Astercoin Core"); // default title
    ...
    // Append title to "Astercoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
