...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Astercoin Core astercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  astercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded astercoin transaction") + "\n" +
              "  astercoin-tx [options] -create [commands]   " + _("Create hex-encoded astercoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded astercoin transaction
