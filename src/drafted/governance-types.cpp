...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AstercoinNetwork") type = AstercoinNetwork;
    if(strType == "AstercoinNetworkVariable") type = AstercoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AstercoinNetwork) s = "AstercoinNetwork";
    if(type == AstercoinNetworkVariable) s = "AstercoinNetworkVariable";
