 ...
 *
 *   // network
 *   CAstercoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.astercoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAstercoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CAstercoinNetwork(UniValue objIn)
    {
...
// // can be under: AstercoinNetwork
// //   -- signature requirements : Key1(User)
// class CAstercoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == AstercoinNetwork);
//     // }
