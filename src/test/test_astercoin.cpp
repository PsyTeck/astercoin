...
#define BOOST_TEST_MODULE Astercoin Test Suite

#include "test_astercoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_astercoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
